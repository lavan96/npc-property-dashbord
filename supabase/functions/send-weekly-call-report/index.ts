    ...
    const emailHtml = `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This report was automatically generated by ${(await getBrandConfig()).companyName} Call Analytics</p>
            <p>© ${new Date().getFullYear()} ${(await getBrandConfig()).companyName}. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
