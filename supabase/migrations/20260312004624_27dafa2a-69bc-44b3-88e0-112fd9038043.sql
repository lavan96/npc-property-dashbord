SELECT cron.schedule(
  'enrich-lead-attributions-30min',
  '*/30 * * * *',
  $$
  SELECT
    net.http_post(
      url := 'https://dduzbchuswwbefdunfct.supabase.co/functions/v1/enrich-lead-attributions',
      ...
      body := '{"source": "scheduled", "batchSize": 15}'::jsonb
    ) AS request_id;
  $$
);