...
export const defaultLightTokenMap: BrandTokenMap = {
  ...
  '--foreground': '35 16% 18%',
  '--card': '38 100% 98%',
  '--card-foreground': '35 16% 18%',
  '--popover': '38 100% 98%',
  '--popover-foreground': '35 16% 18%',
  '--primary': DEFAULT_PRIMARY,
  '--primary-foreground': '0 0% 100%',
  '--primary-hover': '43 74% 42%',
  '--secondary': '40 50% 91%',
  '--secondary-foreground': '35 16% 18%',
  '--secondary-hover': '39 45% 87%',
  '--muted': '40 56% 90%',
  '--muted-foreground': '34 12% 42%',
  ...
  '--sidebar-background': '39 55% 93%',
  '--sidebar-foreground': '35 16% 24%',
  '--sidebar-primary': DEFAULT_PRIMARY,
  '--sidebar-primary-foreground': '0 0% 100%',
  '--sidebar-accent': DEFAULT_ACCENT,
  '--sidebar-accent-foreground': '0 0% 100%',
  '--sidebar-border': '36 34% 82%',
  '--sidebar-ring': DEFAULT_PRIMARY,
  '--dashboard-surface': '38 100% 98%',
  '--dashboard-surface-elevated': '42 80% 97%',
  '--dashboard-surface-muted': '40 56% 90%',
  '--dashboard-border-soft': '36 34% 80%',
  '--dashboard-border-strong': '38 36% 72%',
  '--dashboard-primary-soft': '43 74% 90%',
  '--dashboard-primary-strong': DEFAULT_PRIMARY,
  '--surface-1': '38 100% 98%',
  '--surface-2': '42 80% 97%',
  '--surface-3': '40 56% 90%',
  '--surface-elevated': '38 100% 98%',
  '--surface-muted': '40 56% 90%',
  '--border-soft': '36 34% 80%',
  '--border-strong': '38 36% 72%',
  '--topbar-background': '38 100% 98%',
  '--sidebar-surface': '39 55% 93%',
  '--mobile-nav-background': '38 100% 98%',
};
