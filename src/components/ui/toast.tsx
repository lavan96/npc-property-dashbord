...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 left-0 right-0 z-[100] flex max-h-screen w-full flex-col gap-2 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] sm:top-auto sm:left-auto sm:bottom-24 sm:right-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
