  ...
  return (
    <div className="rounded-[1.5rem] border border-primary/15 bg-card/90 p-3 shadow-2xl shadow-black/10 backdrop-blur-xl sm:p-4">
      ...
      <div className="mt-3 flex flex-col gap-2 border-t border-border/50 pt-3 sm:flex-row sm:flex-wrap sm:items-center">
        <div className="flex min-h-11 w-full items-center overflow-hidden sm:w-auto rounded-2xl border border-amber-300/25 bg-gradient-to-b from-background/95 to-muted/35 p-1 shadow-[inset_0_1px_0_hsl(var(--background)),0_14px_34px_hsl(43_74%_49%/0.09)]" role="group" aria-label="Chart view mode">
          {[
            ...
            return (
              <Button
                ...
                size="sm"
                className={cn(
                  'relative h-10 min-w-11 flex-1 rounded-xl px-3 sm:flex-none text-muted-foreground transition-all duration-200 focus-visible:ring-2 focus-visible:ring-amber-300/45 focus-visible:ring-offset-0',
                  'hover:-translate-y-0.5 hover:bg-amber-500/12 hover:text-foreground hover:shadow-[0_8px_20px_hsl(43_74%_49%/0.12)] active:translate-y-0',
                  active && 'bg-gradient-to-br from-amber-300 via-amber-400 to-primary text-primary-foreground shadow-[0_10px_24px_hsl(43_74%_49%/0.28)] hover:bg-amber-400 hover:text-primary-foreground active:scale-[0.98]'
                )}
