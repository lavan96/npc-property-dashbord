  ...
  return (
    <Dialog open={!!chart} onOpenChange={() => onClose()}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[calc(100dvh-1rem)] w-[calc(100vw-0.75rem)] max-w-7xl -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-card-xl border border-brand-300/25 bg-[linear-gradient(145deg,hsl(var(--card)/0.99),hsl(var(--background)/0.96))] p-0 shadow-[0_32px_90px_rgba(0,0,0,0.62)] ring-1 ring-border backdrop-blur-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:max-h-[calc(100dvh-2rem)] sm:w-[min(96vw,86rem)] dark:ring-white/10">
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-contain p-3 pb-5 sm:p-6 sm:pb-7 lg:p-7">
            ...
            <div className="relative mt-4 min-h-0 w-full min-w-0 px-0 sm:mt-5 sm:px-14">
              <div className="relative flex h-[clamp(220px,42dvh,520px)] min-h-0 w-full min-w-0 items-center justify-center overflow-hidden rounded-card-xl border border-brand-200/25 bg-[radial-gradient(circle_at_50%_0%,hsl(var(--primary)/0.14),transparent_42%),linear-gradient(145deg,hsl(222_47%_11%/0.96),hsl(220_40%_6%/0.94))] p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-24px_60px_rgba(0,0,0,0.28),0_22px_64px_rgba(0,0,0,0.30)] ring-1 ring-border dark:ring-white/10 sm:p-5 lg:p-7">
                ...
                <div className="relative flex h-full w-full min-w-0 items-center justify-center overflow-hidden rounded-[1.25rem] border border-border/85 bg-white p-2 shadow-[0_20px_58px_rgba(0,0,0,0.34),inset_0_0_0_1px_rgba(15,23,42,0.06)] sm:p-6 lg:p-8 dark:border-white/15">
            ...
            {chart.analysis_text && (
              <div className="mt-4 rounded-2xl border border-brand-300/25 bg-[radial-gradient(circle_at_top_left,hsl(43_96%_56%/0.16),transparent_42%),linear-gradient(145deg,hsl(var(--background)/0.98),hsl(var(--muted)/0.24))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.45),0_12px_32px_rgba(0,0,0,0.10)] dark:bg-[radial-gradient(circle_at_top_left,hsl(43_96%_56%/0.16),transparent_42%),linear-gradient(145deg,hsl(var(--card)),hsl(var(--muted)/0.12))]">
