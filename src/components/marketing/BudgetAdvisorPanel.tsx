            ...
            {showAI && (
              <div className="mt-2">
                {aiError ? (
                  ...
                  <div className="prose prose-sm dark:prose-invert max-w-none prose-p:text-xs prose-p:my-1 prose-strong:text-foreground prose-li:text-xs prose-li:my-0 prose-headings:text-xs prose-headings:mt-2 prose-headings:mb-1 prose-ul:my-1 prose-ol:my-1">
