...
export function CashFlowTemplateList() {
    ...
    try {
      ...
      toast({
        ...
        description: template.is_active 
          ? 'The default template will be used for Cash Flow exports'
          : `"${template.name}" will now be used for Cash Flow exports`,
      });
      ...
      logActivityDirect({
        ...
        metadata: { template_type: 'cashflow_export' },
      });
    ...
    return (
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">No Cash Flow Export Templates</h3>
          <p className="text-sm text-muted-foreground max-w-md">
            Upload a PDF template to customize how 10-Year Cash Flow analyses are exported. 
      ...
      {activeTemplate ? (
        ...
        <div className="flex items-center gap-2 p-3 rounded-lg bg-muted border">
          ...
          <span className="text-sm text-muted-foreground">
            No active template - using default styling for Cash Flow exports
          </span>
        </div>
      )}
