...
import { MISSION_CONTROL_SEATS_URL, openMissionControlWithAttribution } from '@/lib/missionControl';
        ...
        {loading ? (
          ...
          <>
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <Button variant="outline" size="sm" onClick={() => void openMissionControlWithAttribution('seat_plan', MISSION_CONTROL_SEATS_URL)}>
                Manage plan
