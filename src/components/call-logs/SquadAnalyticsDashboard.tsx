...
const squadChartShell = 'rounded-2xl border border-white/10 bg-black/20 p-3';
  ...
  return (
    <div className="space-y-6">
      <Card className={squadPanel}>
        ...
        <CardHeader className="relative border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(245,158,11,0.14),transparent_34%),linear-gradient(90deg,rgba(24,24,27,0.92),rgba(0,0,0,0.72),rgba(126,34,206,0.16))]">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card className={cn(squadKpiCard, 'from-purple-500/15 via-zinc-950/85 to-black/95 hover:border-purple-300/35 hover:shadow-purple-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Squad Calls</p>
                <p className="text-3xl font-bold text-zinc-50">{summaryStats.totalSquadCalls}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(squadKpiCard, 'from-emerald-500/15 via-zinc-950/85 to-black/95 hover:border-emerald-300/35 hover:shadow-emerald-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
        ...
        <Card className={cn(squadKpiCard, 'from-blue-500/15 via-zinc-950/85 to-black/95 hover:border-blue-300/35 hover:shadow-blue-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Avg Handoffs</p>
                <p className="text-3xl font-bold text-zinc-50">{handoffStats.avgHandoffs}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(squadKpiCard, 'from-amber-500/15 via-zinc-950/85 to-black/95')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Avg Agents/Call</p>
                <p className="text-3xl font-bold text-amber-200">{avgAgentsPerCall}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(squadKpiCard, 'from-cyan-500/15 via-zinc-950/85 to-black/95 hover:border-cyan-300/35 hover:shadow-cyan-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-3xl font-bold text-zinc-50">{formatDuration(summaryStats.avgDuration)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className={squadChartCard}>
          <CardHeader className="relative border-b border-white/10 bg-gradient-to-r from-purple-500/10 via-transparent to-amber-500/10">
            ...
            <CardDescription className="text-zinc-400">Breakdown of caller intents (discovery, strategy, finance)</CardDescription>
          </CardHeader>
          <CardContent className="p-4">
            {intentData.length > 0 ? (
        ...
        <Card className={squadChartCard}>
          <CardHeader className="relative border-b border-white/10 bg-gradient-to-r from-emerald-500/10 via-transparent to-blue-500/10">
            <CardTitle className="flex items-center gap-2 text-base text-zinc-50">
              <TrendingUp className="h-5 w-5 text-emerald-300" />
              Success Rate by Intent
            </CardTitle>
            <CardDescription className="text-zinc-400">Completion rates for each call intent type</CardDescription>
          </CardHeader>
          <CardContent className="p-4">
      ...
      <Card className={squadChartCard}>
        <CardHeader className="relative border-b border-white/10 bg-gradient-to-r from-purple-500/10 via-transparent to-blue-500/10">
          <CardTitle className="flex items-center gap-2 text-base text-zinc-50">
            <Users className="h-5 w-5 text-purple-300" />
            Squad Assistant Performance
          </CardTitle>
          <CardDescription className="text-zinc-400">Individual assistant involvement and completion rates in squad calls</CardDescription>
        </CardHeader>
        <CardContent className="p-4">
            ...
            <div className="space-y-3">
              {assistantStats.map((assistant, index) => {
                const successRate = assistant.count > 0 
                  ...
                  : 0;
                return (
                  <div key={assistant.id} className="group flex items-center justify-between rounded-2xl border border-white/10 bg-white/[0.03] p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-300/30 hover:bg-amber-300/[0.06] hover:shadow-lg hover:shadow-amber-500/10">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="truncate font-semibold text-zinc-100">{assistant.name}</p>
                        <p className="truncate font-mono text-xs text-zinc-500">{assistant.id.slice(0, 12)}...</p>
                      </div>
                    </div>
                    <div className="flex shrink-0 items-center gap-4">
                      <div className="text-right">
                        <p className="text-sm font-semibold text-zinc-100">{assistant.count} calls</p>
                        <p className="text-xs text-zinc-500">{assistant.completed} completed</p>
                      </div>
                      <Badge 
        ...
        <Card className={cn(squadKpiCard, 'from-blue-500/15 via-zinc-950/85 to-black/95 hover:border-blue-300/35 hover:shadow-blue-500/10')}>
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="text-3xl font-bold text-zinc-50">{handoffStats.totalHandoffs}</p>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Total Handoffs</p>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(squadKpiCard, 'from-emerald-500/15 via-zinc-950/85 to-black/95 hover:border-emerald-300/35 hover:shadow-emerald-500/10')}>
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="text-3xl font-bold text-zinc-50">{handoffStats.maxHandoffs}</p>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Max Handoffs (Single Call)</p>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(squadKpiCard, 'from-purple-500/15 via-zinc-950/85 to-black/95 hover:border-purple-300/35 hover:shadow-purple-500/10')}>
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="text-3xl font-bold text-zinc-50">{handoffStats.callsWithHandoffs}</p>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500">Calls With Handoffs</p>
            </div>
          </CardContent>
        </Card>
      </div>
