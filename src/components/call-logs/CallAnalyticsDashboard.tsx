  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card className={cn(analyticsKpiCard, 'from-emerald-500/15 via-card dark:via-zinc-950/85 to-background dark:to-black/95 hover:border-emerald-300/35 hover:shadow-emerald-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-muted-foreground dark:text-zinc-500">Positive Sentiment</p>
                <p className="text-3xl font-bold text-foreground dark:text-zinc-50">{summaryStats.sentimentScore}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(analyticsKpiCard, 'from-blue-500/15 via-card dark:via-zinc-950/85 to-background dark:to-black/95 hover:border-blue-300/35 hover:shadow-blue-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
        ...
        <Card className={cn(analyticsKpiCard, 'from-purple-500/15 via-card dark:via-zinc-950/85 to-background dark:to-black/95 hover:border-purple-300/35 hover:shadow-purple-500/10')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-muted-foreground dark:text-zinc-500">Active Agents</p>
                <p className="text-3xl font-bold text-foreground dark:text-zinc-50">{summaryStats.uniqueAgents}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card className={cn(analyticsKpiCard, 'from-amber-500/15 via-card dark:via-zinc-950/85 to-background dark:to-black/95')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.16em] text-muted-foreground dark:text-zinc-500">AI Analyzed</p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className={analyticsChartCard}>
          <CardHeader className="relative border-b border-border dark:border-white/10 bg-gradient-to-r from-emerald-500/10 via-transparent to-amber-500/10">
            <CardTitle className="flex items-center gap-2 text-base text-foreground dark:text-zinc-50">
              <Smile className="h-5 w-5 text-emerald-300" />
              Sentiment Distribution
            </CardTitle>
            <CardDescription className="text-muted-foreground dark:text-zinc-400">Customer sentiment analysis across all calls</CardDescription>
          </CardHeader>
          <CardContent className="p-4">
        ...
        {/* Call Outcomes */}
        <Card className={analyticsChartCard}>
          <CardHeader className="relative border-b border-border dark:border-white/10 bg-gradient-to-r from-blue-500/10 via-transparent to-emerald-500/10">
            <CardTitle className="flex items-center gap-2 text-base text-foreground dark:text-zinc-50">
              <TrendingUp className="h-5 w-5 text-blue-300" />
              Call Outcomes
            </CardTitle>
            <CardDescription className="text-muted-foreground dark:text-zinc-400">Distribution of call results</CardDescription>
          </CardHeader>
          <CardContent className="p-4">
      ...
      <Card className={analyticsChartCard}>
        <CardHeader className="relative border-b border-border dark:border-white/10 bg-gradient-to-r from-purple-500/10 via-transparent to-amber-500/10">
          ...
          <CardDescription className="text-muted-foreground dark:text-zinc-400">Comparison of agent metrics and success rates</CardDescription>
        </CardHeader>
        <CardContent className="p-4">
