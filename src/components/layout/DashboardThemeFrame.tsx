...
const variantClasses: Record<DashboardThemeFrameVariant, string> = {
  ...
  hero:
    'dashboard-theme-hero relative overflow-hidden rounded-[1.5rem] border border-border/70 bg-gradient-to-br from-card via-card to-muted/35 p-4 shadow-sm shadow-black/5 backdrop-blur dark:border-white/10 dark:from-background dark:via-background/90 dark:to-background/70 sm:rounded-[2rem] sm:p-5 md:p-7',
  section:
    'dashboard-theme-section relative min-w-0 overflow-hidden rounded-[1.5rem] border border-border/60 bg-card/65 p-4 shadow-[0_14px_40px_rgba(15,23,42,0.06)] backdrop-blur supports-[backdrop-filter]:bg-card/55 sm:rounded-[1.85rem] sm:p-5 md:p-6 dark:border-white/10 dark:bg-background/35 dark:shadow-black/25',
  sectionAccent:
    'dashboard-theme-section dashboard-theme-section-accent relative min-w-0 overflow-hidden rounded-[1.5rem] border border-primary/30 bg-gradient-to-br from-primary/10 via-card/75 to-card p-4 shadow-[0_14px_40px_rgba(15,23,42,0.06)] backdrop-blur sm:rounded-[1.85rem] sm:p-5 md:p-6 dark:border-primary/25 dark:from-primary/10 dark:via-background/45 dark:to-background/75',
  card:
