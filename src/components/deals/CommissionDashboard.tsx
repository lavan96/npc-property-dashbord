  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">{stats.pendingSlabs.length}</p>
            <p className="text-xs text-muted-foreground">Slab Stages Pending</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">{stats.pendingFrames.length}</p>
            <p className="text-xs text-muted-foreground">Frame Stages Pending</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-green-600">{stats.received.length}</p>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">Stage Amount</TableHead>
                  ...
                  <TableRow key={`${row.dealId}-${row.stageNumber}-${idx}`}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm">{row.stageName}</span>
                      </div>
                    </TableCell>
                    ...
                    <TableCell>
                      {row.fundsReleased ? (
                        <Badge className="text-[10px] bg-amber-500/10 text-amber-700 border-amber-500/30 border">Awaiting Payment</Badge>
                      ) : row.submittedToLender ? (
                        <Badge variant="outline" className="text-[10px]">Submitted</Badge>
                      ) : row.builderInvoiceReceived ? (
                        <Badge variant="outline" className="text-[10px]">Invoice Received</Badge>
                      ) : (
