    ...
    <Card className="hover-scale overflow-hidden border-border/70 bg-gradient-to-br from-card via-card to-muted/20 shadow-sm">
      ...
      <CardContent className="p-4 md:p-5">
        {loading ? (
          ...
          <div className="relative overflow-hidden rounded-2xl border border-dashed border-primary/25 bg-gradient-to-br from-primary/5 via-background to-muted/30 px-5 py-8 text-center shadow-inner">
            ...
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-primary/20 bg-background/85 shadow-sm">
