  ...
  if (error) {
    return (
      <div className={`${OVERVIEW_SHELL} space-y-6`}>
        ...
        <Card className="overflow-hidden rounded-card-lg border-brand-400/40 bg-gradient-to-br from-brand-500/10 via-card to-card shadow-[0_14px_40px_rgba(15,23,42,0.08)] dark:border-brand-400/25 dark:from-brand-400/10 dark:via-background/80 dark:to-background">
