...
export default function TokenUsageHistory() {
  ...
  return (
    <DashboardThemeFrame variant="page" className="min-h-[calc(100vh-5rem)] min-w-0 overflow-x-hidden space-y-7 p-3 sm:p-5 lg:p-6">
      ...
      <Card className="min-w-0 overflow-hidden rounded-card-xl border-border/70 bg-card/95 shadow-[0_22px_60px_rgba(15,23,42,0.10)] transition-shadow duration-200 hover:shadow-[0_28px_75px_rgba(15,23,42,0.13)] ring-1 ring-black/5 dark:border-white/10 dark:bg-background/75 dark:shadow-black/35 dark:ring-white/5">
