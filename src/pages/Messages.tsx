                      ...
                      {filteredClientThreads.map((t) => (
                        ...
                        >
                          <div className="flex items-center justify-between gap-2">
                            ...
                            {t.unread_count > 0 && (
                              <Badge className="shrink-0 rounded-full border border-amber-200/50 bg-primary px-2 text-[10px] font-bold text-primary-foreground shadow-sm shadow-amber-950/20">{t.unread_count}</Badge>
                            )}
                          </div>
                  ...
                  <div className="relative flex h-full min-h-[520px] flex-col items-center justify-center overflow-hidden p-8 text-center text-sm text-muted-foreground lg:min-h-0">
                    ...
                    <div className="relative max-w-sm rounded-3xl border border-white/10 bg-black/25 px-6 py-5 shadow-xl shadow-black/20 backdrop-blur">
                      ...
                      <div className="mt-4 flex flex-wrap justify-center gap-1.5 text-[10px] font-medium text-primary/90">
                        <span className="rounded-full border border-primary/15 bg-amber-300/10 px-2 py-0.5">Search</span>
                        <span className="rounded-full border border-primary/15 bg-amber-300/10 px-2 py-0.5">Review</span>
                        <span className="rounded-full border border-primary/15 bg-amber-300/10 px-2 py-0.5">Reply</span>
                      </div>
                      ...
                      {filteredFinanceGroups.map((g) => (
                        ...
                        >
                          <div className="flex items-center justify-between gap-2">
                            ...
                            {g.unread_total > 0 && (
                              <Badge className="shrink-0 rounded-full border border-amber-200/50 bg-primary px-2 text-[10px] font-bold text-primary-foreground shadow-sm shadow-amber-950/20">{g.unread_total}</Badge>
                            )}
                          </div>
                ...
                {selectedFinanceClientId ? (
                  ...
                  <div className="relative flex h-full min-h-[520px] flex-col items-center justify-center overflow-hidden p-8 text-center text-sm text-muted-foreground lg:min-h-0">
                    ...
                    <div className="relative max-w-sm rounded-3xl border border-white/10 bg-black/25 px-6 py-5 shadow-xl shadow-black/20 backdrop-blur">
                      ...
                      <div className="mt-4 flex flex-wrap justify-center gap-1.5 text-[10px] font-medium text-primary/90">
                        <span className="rounded-full border border-primary/15 bg-amber-300/10 px-2 py-0.5">Partner view</span>
