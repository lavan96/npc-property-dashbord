    ...
    <div className="relative -mx-3 space-y-6 overflow-hidden px-3 pb-20 md:mx-0 md:px-0 md:pb-0">
      ...
      <Tabs defaultValue="clients" className="space-y-5 rounded-2xl border border-border/70 bg-card/70 p-3 shadow-2xl shadow-black/20 backdrop-blur md:p-4">
        <div className="overflow-x-auto -mx-3 px-3 md:mx-0 md:px-0">
          <TabsList className="inline-flex h-auto w-auto min-w-max gap-1 rounded-xl border border-border/70 bg-background/70 p-1">
            <TabsTrigger value="clients" className="rounded-lg px-4 py-2 transition-all data-[state=active]:bg-amber-500 data-[state=active]:text-black data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/20">Clients</TabsTrigger>
            <TabsTrigger value="portfolio-reports" className="rounded-lg px-4 py-2 transition-all data-[state=active]:bg-amber-500 data-[state=active]:text-black data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/20">Portfolio</TabsTrigger>
            <TabsTrigger value="analytics" className="rounded-lg px-4 py-2 transition-all data-[state=active]:bg-amber-500 data-[state=active]:text-black data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/20">Analytics</TabsTrigger>
            <TabsTrigger value="compare" className="rounded-lg px-4 py-2 transition-all data-[state=active]:bg-amber-500 data-[state=active]:text-black data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/20">Compare</TabsTrigger>
            <TabsTrigger value="import" className="rounded-lg px-4 py-2 transition-all data-[state=active]:bg-amber-500 data-[state=active]:text-black data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/20">Import</TabsTrigger>
          </TabsList>
        </div>
