...
for (const name of ['beginTotpEnrollment', 'confirmTotpEnrollment', 'useState<{ token: string; secret: string } | null>']) if (!source.includes(name)) throw new Error(`Missing secure TOTP settings integration: ${name}`);
